...
## Firefox-ESR
The firefox-esr profile is for Debian 10/11. Run `sudo touch /etc/apparmor.d/local/usr.bin.firefox-esr` first, then copy `usr.bin.firefox-esr` from this repository to `/etc/apparmor.d/` and activate the profile.
